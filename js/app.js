...
const themeChangerContainer = document.querySelector("#themeChanger");

(() => {
  const children = [...themeChangerContainer.children];
  const body = document.body;
  children.forEach((colorButton) => {
    const currentColor = colorButton.id;
